...
var defaults = {
    ...
    tooltipToggleThumbnails: 'Переключить превью', // String; Text of tooltip which will be displayed next to icon for toggle thumbnails.; ; [ 'Toggle thumbnails', 'Pokaż/ukryj miniatury' ]
